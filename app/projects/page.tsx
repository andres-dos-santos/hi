  ...
  return (
    <div className="snap-start min-h-screen bg-[#1c1c1c] p-40 grid grid-cols-10">
      <div className="flex flex-col justify-center col-span-4">
        ...
        <div className="flex items-center mt-20">
          <div className="flex items-center">
            ...
            <div className="bg-white/50 mx-10 w-px h-10"></div>
          ...
          <div className="bg-white relative flex items-center gap-3 h-20 px-1 ml-auto min-w-64 rounded-full">
            <div className="absolute h-[72px] w-[72px] bg-[#1c1c1c] rounded-full border border-white"></div>
            <div className="absolute left-[40px] h-[72px] w-[72px] bg-[#1c1c1c] rounded-full border border-white"></div>
            <div className="absolute left-[80px] h-[72px] w-[72px] bg-[#1c1c1c] rounded-full border border-white"></div>
      ...
      <div className="col-span-6 px-40">
        <div className="bg-zinc-800 rounded-3xl h-full"></div>
      </div>
    </div>
  )
}
