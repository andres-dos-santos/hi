  ...
  return (
    <div className="mx-auto h-screen snap-start px-10 sm:px-0 sm:max-w-[700px] flex flex-col items-start justify-center">
      <header className="flex items-center justify-between mb-5 w-full">
        <span className="text-zinc-500 dark:text-zinc-300 font-semibold text-[10px] sm:text-[11px] block">
          OPEN TO WORK
        </span>

        <button className="flex items-center font-semibold text-[10px] sm:text-[11px] tracking-wider group">
          <div className="h-px w-7 sm:w-10 bg-zinc-800 dark:bg-white mr-1.5 transition-all duration-300 group-hover:-translate-x-3"></div>
          DOWNLOAD MY CV
        </button>
      </header>
      ...
      <div className="mt-10">
        <p className="text-zinc-700 dark:text-zinc-300 text-[13px] sm:text-[15px] leading-[1.25rem] sm:leading-[1.65rem]">
          Greetings! I'm{' '}
          <strong className="text-zinc-800 dark:text-white">Andres</strong>, a
